							...
							<!-- <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xs-6 objeto-centro"> -->
								<div class="row">
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xs-12 objeto-centro">
										<form class="form-signin" name="frmLogin" action="process.php" method="POST"
		         enctype="multipart/form-data">
											<div class="form-group">
												<!-- <img class="img-fluid" style="padding: 20px" src="../img/logo.png" alt="" width="250"> -->
												<img class="img-fluid" style="padding: 20px" src="../../assets/img/logo2.png" alt="Ferremayoristas Olvera">
									...
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xs-12" style="background-color: rgba(51,51,51,.7); margin: auto;">
										<p style="color:red;margin: auto;">Error al Iniciar Sesión, favor de intentar de nuevo.</p>
									</div>
								</div>
							<!-- </div> -->
						<!-- </div> -->
