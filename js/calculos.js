function calcular(){
	...
	if (diasActual > 0 && diasAnterior > 0 && diasConteo > 0) {
        ...
        if(proyeccionCierre < 0){
        	...
        	document.getElementById("proyeccionCierre").innerHTML = "<p>Proyección al cierre <br /><b style='font-size:2em;' class='text-redGraf'>(-)$ "+currency(proyeccionCierre)+"</b></p>";
        } else {
        	document.getElementById("proyeccionCierre").innerHTML = "<p>Proyección al cierre <br /><b style='font-size:2em;' class='text-blue'>(+)$ "+currency(proyeccionCierre)+"</b></p>";
        }
        if(ventaDiaIgualar < 0){
        	document.getElementById("ventaPorDiaIgualar").innerHTML = "<p>Venta por día para igualar <br /><b style='font-size:2em;' class='text-redGraf'>$ "+currency(ventaDiaIgualar)+"</b></p>";
        } else {
        	document.getElementById("ventaPorDiaIgualar").innerHTML = "<p>Venta por día para igualar <br /><b style='font-size:2em;' class='text-blue'>$ "+currency(ventaDiaIgualar)+"</b></p>";
        }
    } else {
