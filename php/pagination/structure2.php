...
$paramsPagination["limit"] = $limitPages;
  ...
  if($totalPages > 1) {
    ...
    if($currentPage != 1) {
      ...
      $pagination .= "<li>";
      $pagination .=    "<a href='#' onclick='pagination($paramsSendPagination)'>";
    ...
    for($i = $initLimitPages ; $i <= $limitPages; $i++) {
      if ($currentPage == $i) {
        ...
        $pagination .= "<li><a style='color: #F89D97 !important'>$currentPage</a></li>";
      } else {
        ...
        $pagination .= "<li>";
        $pagination .=    "<a href='#' onclick='pagination($paramsSendPagination)'>" .$i. "</a>";
        $pagination .=  "</li>";
      }
    }
