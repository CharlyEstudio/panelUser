...
if((int)$_POST["vendedor"] > 0){
    ...
    <tr>
    <th>
    <p> <strong>Vendedor</strong><br> '.iconv("UTF-8", "ISO-8859-1", $nombreVendedor).' </p>
    </th>
    </tr>
    </table>
    </th>
    ...
    try {
        ...
        $mail->IsHTML(true);
        $mail->Subject = utf8_decode('NUEVO CLIENTE');
        $mail->Body = $cuerpo;
        $mail->Send();
    ...
    <tr>
    <th>
    <h1>CLIENTE AUTORIZADO</h1>
    <p>Se ha autorizado el siguiente cliente.</p>
    <table class="spacer">
    <tbody>
    <tr>
    <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
    ...
    try {
        ...
        $mail->IsHTML(true);
        $mail->Subject = utf8_decode('CLIENTE AUTORIZADO');
        $mail->Body = $cuerpo;
        $mail->Send();
    } catch (Exception $mail) {
    }
