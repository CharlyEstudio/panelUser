<?php
	if(!isset($_SESSION["data"])) {
        ...
        $buscarRol = mysqli_fetch_array($buscarRolNav);
...
<?php
        if($rol) {
            $nav = $paramFunctions->drawNavMenu($rol, $disponible, $saldo, $diasRestantesNewMes, $vendedor, $ignorasuspender, $activo, $user);
            echo $nav;
...
<?php
        ...
        if($usuario == 'distribuidor' || $usuario == 'subdistribuidor' || $usuario == 'mayoreo'){
